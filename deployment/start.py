...
if __name__ == "__main__":
    ...
    run_instance('slave 1', 't2.medium', False, [cfg.GLOBAL_SECURITY_GROUP])
    run_instance('slave 2', 't2.medium', False, [cfg.GLOBAL_SECURITY_GROUP])
    run_instance('slave 3', 't2.medium', False, [cfg.GLOBAL_SECURITY_GROUP])
    run_instance('slave 4', 't2.medium', False, [cfg.GLOBAL_SECURITY_GROUP])
    run_instance('slave 5', 't2.medium', False, [cfg.GLOBAL_SECURITY_GROUP])
